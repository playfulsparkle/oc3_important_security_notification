...
const outputPath = path.join(__dirname, "/dist/ps_important_security_notification.ocmod.zip");
...
output.on("close", function () {
  ...
  console.log("ps_important_security_notification.ocmod.zip has been created");
